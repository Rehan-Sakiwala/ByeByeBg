      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">
            Choose from our best pricing plans!
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-black-400">
            Select from our carefully curated packages based on your
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`relative pt-6 p-6 ${
                plan.popular
                  ? "backdop-blur-lg rounded-2xl"
                  : "border-gray-800 rounded-xl"
              } bg-[#1A1A1A] hover:transform hover:-translate-y-2 transition-all duration-300`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-purple-600 px-3 py-1 text-white text-size-sm font-semibold">
                  Most Popular
                </div>
              )}
